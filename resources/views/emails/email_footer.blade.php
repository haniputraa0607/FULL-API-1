						...
						<tr>
							@if(isset($setting['email_setting_url']['url_app_store']) && $setting['email_setting_url']['url_app_store']->use == 1)
								<td style="padding-right: 10px;">
									<a href="{{$setting['email_setting_url']['url_app_store']->url}}" style="color:#a30046!important;font-family:\'Source Sans Pro\',sans-serif;line-height:1.5;margin:0;padding:0;text-decoration:none" target="_blank" data-saferedirecturl="https://www.google.com/url?q=http://facebook.com/vourest&amp;source=gmail&amp;ust=1539830594941000&amp;usg=AFQjCNGWeiiiMPqpyJLEsoW2fEKq_Eg8Qg"><img class="m_6657055476784441913CToWUd CToWUd" alt="Vourest"  height="50" style="width:100%;max-height:50px;" src="{{env('S3_URL_API')}}{{$setting['email_setting_url']['url_play_store']->icon}}">
									</a>
								</td>
							@endif
							@if(isset($setting['email_setting_url']['url_app_store']) && $setting['email_setting_url']['url_app_store']->use == 1)
								<td style="padding-right: 10px;">
									<a href="{{$setting['email_setting_url']['url_app_store']->url}}" style="color:#a30046!important;font-family:\'Source Sans Pro\',sans-serif;line-height:1.5;margin:0;padding:0;text-decoration:none" target="_blank" data-saferedirecturl="https://www.google.com/url?q=http://facebook.com/vourest&amp;source=gmail&amp;ust=1539830594941000&amp;usg=AFQjCNGWeiiiMPqpyJLEsoW2fEKq_Eg8Qg"><img class="m_6657055476784441913CToWUd CToWUd" alt="Vourest" height="50" style="width:100%;max-height:50px;" src="{{env('S3_URL_API')}}{{$setting['email_setting_url']['url_app_store']->icon}}">
									</a>
								</td>
							@endif
							@if(isset($setting['email_setting_url']['url_facebook']) && $setting['email_setting_url']['url_facebook']->use == 1)
								<td style="padding-right: 10px;">
									<a href="{{$setting['email_setting_url']['url_facebook']->url}}" style="color:#a30046!important;font-family:\'Source Sans Pro\',sans-serif;line-height:1.5;margin:0;padding:0;text-decoration:none" target="_blank" data-saferedirecturl="https://www.google.com/url?q=http://facebook.com/vourest&amp;source=gmail&amp;ust=1539830594941000&amp;usg=AFQjCNGWeiiiMPqpyJLEsoW2fEKq_Eg8Qg"><img class="m_6657055476784441913CToWUd CToWUd" alt="Vourest" height="50" style="width:100%;max-height:50px;" src="{{env('S3_URL_API')}}{{$setting['email_setting_url']['url_facebook']->icon}}">
									</a>
								</td>
							@endif
							@if(isset($setting['email_setting_url']['url_twitter']) && $setting['email_setting_url']['url_twitter']->use == 1)
								<td style="padding-right: 10px;">
									<a href="{{$setting['email_setting_url']['url_twitter']->url}}" style="color:#a30046!important;font-family:\'Source Sans Pro\',sans-serif;line-height:1.5;margin:0;padding:0;text-decoration:none" target="_blank" data-saferedirecturl="https://www.google.com/url?q=http://twitter.com/vourest&amp;source=gmail&amp;ust=1539830594942000&amp;usg=AFQjCNFU-RYCdNoEDIlYotUjxZSzGiS4MQ"><img class="m_6657055476784441913CToWUd CToWUd" alt="Twitter" height="50" style="width:100%;max-height:50px;" src="{{env('S3_URL_API')}}{{$setting['email_setting_url']['url_twitter']->icon}}">
									</a>
								</td>
							@endif
							@if(isset($setting['email_setting_url']['url_youtube']) && $setting['email_setting_url']['url_youtube']->use == 1)
								<td style="padding-right: 10px;">
									<a href="{{$setting['email_setting_url']['url_youtube']->url}}" style="color:#a30046!important;font-family:\'Source Sans Pro\',sans-serif;line-height:1.5;margin:0;padding:0;text-decoration:none" target="_blank" data-saferedirecturl="https://www.google.com/url?q=http://www.youtube.com/vourest&amp;source=gmail&amp;ust=1539830594942000&amp;usg=AFQjCNEfmZGNe04AZP2K-64HjMoAjJAa9g"><img class="m_6657055476784441913CToWUd CToWUd" alt="Youtube" height="50" style="width:100%;max-height:50px;" src="{{env('S3_URL_API')}}{{$setting['email_setting_url']['url_youtube']->icon}}">
									</a>
								</td>
							@endif
							@if(isset($setting['email_setting_url']['url_instagram']) && $setting['email_setting_url']['url_instagram']->use == 1)
								<td style="padding-right: 10px;">
									<a href="{{$setting['email_setting_url']['url_instagram']->url}}" style="color:#a30046!important;font-family:\'Source Sans Pro\',sans-serif;line-height:1.5;margin:0;padding:0;text-decoration:none" target="_blank" data-saferedirecturl="https://www.google.com/url?q=http://instagram.com/vourest&amp;source=gmail&amp;ust=1539830594942000&amp;usg=AFQjCNFYprz1ONgwlv6RIGRZq7RtmnwI0Q"><img class="m_6657055476784441913CToWUd CToWUd" alt="Instagram" height="50" style="width:100%;max-height:50px;" src="{{env('S3_URL_API')}}{{$setting['email_setting_url']['url_instagram']->icon}}">
									</a>
								</td>
							@endif
						</tr>
