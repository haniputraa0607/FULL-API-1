						...
						<tr>
							@if(isset($setting['email_setting_url']['url_play_store']) && $setting['email_setting_url']['url_play_store']->use == 1)
								<td style="padding-right: 10px;">
									<a href="{{$setting['email_setting_url']['url_play_store']->url}}" style="color:#a30046!important;font-family:\'Source Sans Pro\',sans-serif;line-height:1.5;margin:0;padding:0;text-decoration:none" target="_blank"><img class="m_6657055476784441913CToWUd CToWUd" alt="Play Store"  height="50" style="max-height:50px;" src="{{env('S3_URL_API')}}{{$setting['email_setting_url']['url_play_store']->icon}}">
									</a>
								</td>
							@endif
							@if(isset($setting['email_setting_url']['url_app_store']) && $setting['email_setting_url']['url_app_store']->use == 1)
								<td style="padding-right: 10px;">
									<a href="{{$setting['email_setting_url']['url_app_store']->url}}" style="color:#a30046!important;font-family:\'Source Sans Pro\',sans-serif;line-height:1.5;margin:0;padding:0;text-decoration:none" target="_blank"><img class="m_6657055476784441913CToWUd CToWUd" alt="App Store" height="50" style="max-height:50px;" src="{{env('S3_URL_API')}}{{$setting['email_setting_url']['url_app_store']->icon}}">
									</a>
								</td>
							@endif
							@if(isset($setting['email_setting_url']['url_facebook']) && $setting['email_setting_url']['url_facebook']->use == 1)
								<td style="padding-right: 10px;">
									<a href="{{$setting['email_setting_url']['url_facebook']->url}}" style="color:#a30046!important;font-family:\'Source Sans Pro\',sans-serif;line-height:1.5;margin:0;padding:0;text-decoration:none" target="_blank"><img class="m_6657055476784441913CToWUd CToWUd" alt="Facebook" height="50" style="max-height:50px;" src="{{env('S3_URL_API')}}{{$setting['email_setting_url']['url_facebook']->icon}}">
									</a>
								</td>
							@endif
							@if(isset($setting['email_setting_url']['url_twitter']) && $setting['email_setting_url']['url_twitter']->use == 1)
								<td style="padding-right: 10px;">
									<a href="{{$setting['email_setting_url']['url_twitter']->url}}" style="color:#a30046!important;font-family:\'Source Sans Pro\',sans-serif;line-height:1.5;margin:0;padding:0;text-decoration:none" target="_blank"><img class="m_6657055476784441913CToWUd CToWUd" alt="Twitter" height="50" style="max-height:50px;" src="{{env('S3_URL_API')}}{{$setting['email_setting_url']['url_twitter']->icon}}">
									</a>
								</td>
							@endif
							@if(isset($setting['email_setting_url']['url_youtube']) && $setting['email_setting_url']['url_youtube']->use == 1)
								<td style="padding-right: 10px;">
									<a href="{{$setting['email_setting_url']['url_youtube']->url}}" style="color:#a30046!important;font-family:\'Source Sans Pro\',sans-serif;line-height:1.5;margin:0;padding:0;text-decoration:none" target="_blank"><img class="m_6657055476784441913CToWUd CToWUd" alt="Youtube" height="50" style="max-height:50px;" src="{{env('S3_URL_API')}}{{$setting['email_setting_url']['url_youtube']->icon}}">
									</a>
								</td>
							@endif
							@if(isset($setting['email_setting_url']['url_instagram']) && $setting['email_setting_url']['url_instagram']->use == 1)
								<td style="padding-right: 10px;">
									<a href="{{$setting['email_setting_url']['url_instagram']->url}}" style="color:#a30046!important;font-family:\'Source Sans Pro\',sans-serif;line-height:1.5;margin:0;padding:0;text-decoration:none" target="_blank"><img class="m_6657055476784441913CToWUd CToWUd" alt="Instagram" height="50" style="max-height:50px;" src="{{env('S3_URL_API')}}{{$setting['email_setting_url']['url_instagram']->icon}}">
									</a>
								</td>
							@endif
						</tr>
